...
import com360Training.employee.dto.AddressDto;
...
public class EmployeesServiceIT {
    ...
    void testSaveThanFindById() {
        when(addressesGateway.getAddress(any()))
                .thenReturn(new AddressDto("Budapest", "Fo u. 1."));

        EmployeeDto employee = employeesService
                .create(new CreateEmployeeCommand("John Doe"));
